...
<body>
    ...
    <!-- Navbar Start -->
    @if($navbar)
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0 navbar-{{ $navbar->position }} navbar-{{ $navbar->alignment }}">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    @foreach ($navbarItems as $item)
                        <a href="{{ $item->url }}"
                            class="nav-item nav-link {{ $item->active ? 'active' : '' }}">{{ $item->label }}</a>
                    @endforeach
                </div>
                @if (Route::has('login'))
                    @auth
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Dashboard<i
                                class="fa fa-arrow-right ms-3"></i></a>
                    @endauth
                @endif
            </div>
                                ...
                                <div class="row justify-content-start">
                                    <div class="col-sm-10 col-lg-8">
                                        <h5 class="text-primary text-uppercase mb-3 animated 
                                                 slideInDown">{{ $slider->title }}</h5>
                                        <h1 class="display-3 text-white animated slideInDown">{{ $slider->subtitle }}</h1>
        ...
        <div class="container-xxl py-5 category">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                 ...
                 text-primary px-3">Categories</h6>
                    <h1 class="mb-5">Courses Categories</h1>
                </div>
                <div class="row g-3">
                    @foreach($departments as $department)
                                <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                                    <a class="position-relative d-block overflow-hidden" href="{{ route(
                            'department.courses',
                            $department->id
                        ) }}">
                                        <img class="img-fluid" src="{{ asset($department->image) }}"
                                            alt="{{ $department->department_name }}">
                                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                            style="margin: 1px;">
                                            <h5 class="m-0">{{ $department->department_name }}</h5>
                                        </div>
                                    </a>
                                </div>
                    @endforeach
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="course-item bg-light">
                                <div class="position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{ asset($course->image) }}" alt="{{ $course->course_name }}">
                                </div>
                            ...
                            <div class="team-item bg-light">
                                <div class="overflow-hidden">
                                    ...
                                    <img class="img-fluid" src="{{ 
                                     asset($instructor->image) }}" alt="{{ $instructor->name }}">
                                </div>

                                <div class="text-center p-4">
                                    <h5 class="mb-0">{{ $instructor->name }}</h5>
                                    <small>{{ $instructor->department->department_name }}</small>
                                </div>
