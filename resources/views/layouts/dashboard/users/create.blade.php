...
<div class="col-md-12">
    ...
    <div class="card card-dark">
        ...
        <!-- form start -->
        @csrf
        <form id="quickForm" novalidate="novalidate" action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="role" class="form-control @error('role') is-invalid @enderror" id="role">
                        ...
                        <option value="doctors" {{ old('role') == 'doctors' ? 'selected' : '' }}>Doctors</option>
                 ...
                 <div class="form-group">
                    ...
                    <select name="academic_level" class="form-control @error('academic_level') is-invalid @enderror" id="academic_level">
                        ...
                        <option value="1" {{ old('academic_level') == '1' ? 'selected' : '' }}>First Year</option>
                        <option value="2" {{ old('academic_level') == '2' ? 'selected' : '' }}>Second Year</option>
                        <option value="3" {{ old('academic_level') == '3' ? 'selected' : '' }}>Third Year</option>
                        <option value="4" {{ old('academic_level') == '4' ? 'selected' : '' }}>Fourth Year</option>
                        <option value="graduated" {{ old('academic_level') == 'graduated' ? 'selected' : '' }}>Graduated</option>
                    </select>
                ...
                <div class="form-group"  id="gpa-field" style="display:none;">
                    ...
                    <input type="number" name="GPA" step="0.01"  min="0" max="4" class="form-control @error('GPA') is-invalid @enderror" id="GPA" placeholder="Enter Your PGPA Number" value="{{ old('GPA') }}">
                    @error('GPA')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" id="address" placeholder="Enter Your Address" value="{{ old('address') }}">
                    @error('address')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
