                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <select name="academic_years" class="form-control @error('academic_years') is-invalid @enderror" id="academic_years">
                        ...
                        <option value="1" {{ old('academic_years') == '1' ? 'selected' : '' }}>First Year</option>
                        <option value="2" {{ old('academic_years') == '2' ? 'selected' : '' }}>Second Year</option>
                        <option value="3" {{ old('academic_years') == '3' ? 'selected' : '' }}>Third Year</option>
                        <option value="4" {{ old('academic_years') == '4' ? 'selected' : '' }}>Fourth Year</option>
                        <option value="graduated" {{ old('academic_years') == 'graduated' ? 'selected' : '' }}>Graduated</option>
                    </select>
