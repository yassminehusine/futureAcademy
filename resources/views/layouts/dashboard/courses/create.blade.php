...
<div class="col-md-12">
    ...
    <div class="form-group">
            ...
            <input type="text" name="course_name" class="form-control" id="course_name" value="{{ old('course_name') }}" required>
            @error('course_name')
    ...
    <div class="form-group">
       ...
       <div class="form-group">
            ...
            <input type="text" name="credit_hours" class="form-control" id="credit_hours" value="{{ old('credit_hours') }}" required>
            @error('credit_hours')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
